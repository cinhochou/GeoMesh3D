...
// B3：透传实际失效原因到登录页 banner 文案，避免 S1 主动退出后被告知"登录状态已过期"的语义不一致
const goToLogin = () => {
